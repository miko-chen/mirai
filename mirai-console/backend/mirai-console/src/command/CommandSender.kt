...
/**
 * 一个可能支持 Ansi 信息的 [CommandSender]
 *
 * @see AnsiMessageBuilder
 * @see CommandSender.sendAnsiMessage
 */
public interface AnsiMessageSupportedCommandSender : CommandSender {
    public val isAnsiSupported: Boolean get() = true
}
 ...
 */
public interface SystemCommandSender : CommandSender
 ...
 *
 * @see PermitteeId
 * @see AnsiMessageSupportedCommandSender
 */
public interface PluginCustomCommandSender : CommandSender, AnsiMessageSupportedCommandSender, SystemCommandSender {
 ...
 * 控制台拥有一切指令的执行权限.
 */
public object ConsoleCommandSender : AbstractCommandSender(), AnsiMessageSupportedCommandSender, SystemCommandSender {
